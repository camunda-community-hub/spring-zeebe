...
/**
 * Reads the annotation properties of {@link Annotation} from given {@link BeanInfo} and returns them
 * as {@link ZeebeAnnotationValue}.
 *
 * @param <B> type of {@link BeanInfo}, either {@link io.zeebe.spring.client.bean.ClassInfo} or {@link io.zeebe.spring.client.bean.MethodInfo}.
