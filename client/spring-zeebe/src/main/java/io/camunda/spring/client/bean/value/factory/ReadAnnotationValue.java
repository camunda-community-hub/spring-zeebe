...
import io.camunda.spring.client.bean.value.ZeebeAnnotationValue;
 ...
 *
 * @param <B> type of {@link BeanInfo}, either {@link io.camunda.spring.client.bean.ClassInfo} or
 * {@link io.camunda.spring.client.bean.MethodInfo}.
