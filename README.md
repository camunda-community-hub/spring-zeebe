...
> [!CAUTION]
> This community maintained project will be archived. For the fully supported Camunda Spring SDK, refer to the [docs](https://docs.camunda.io/docs/apis-tools/spring-zeebe-sdk/getting-started/). The Operate client was moved to a [dedicated repository](https://github.com/camunda-community-hub/camunda-operate-client-java).
